...
var BaseStyle = {
  ...
  load: function load(style2) {
    ...
    return s(computedStyle) ? useStyle(Y(computedStyle), _objectSpread2({
      name: this.name
    }, options)) : {};
  },
