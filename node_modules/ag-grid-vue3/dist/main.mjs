...
var m = (l, t, e) => N(l, typeof t != "symbol" ? t + "" : t, e);
  ...
  createWrapper(e) {
    ...
    class p extends ce {
      ...
      callMethod(n, a) {
        ...
        {
          const C = ((B = u.$.exposed) == null ? void 0 : B[n]) || ((h = u.exposed) == null ? void 0 : h[n]) || u.$.setupState[n];
          return C == null ? void 0 : C.apply(u, a);
        }
      }
      addMethod(n, a) {
        i[n] = a;
...
function R(l) {
  const t = (e) => Ce(e) ? x(e) : Array.isArray(e) ? e.map((o) => t(o)) : _(e) || j(e) || q(e) ? t(x(e)) : e;
  return t(l);
}
  ...
  setup(l, { expose: t, emit: e }) {
    ...
    H().filter((r) => r != "gridOptions").forEach((r) => {
      M(
        () => B[r],
        (s, v) => {
          (r === "rowData" && !w.value || r !== "rowData") && b(r, s), w.value = !1;
        },
        { deep: !0 }
      );
    });
    const h = /* @__PURE__ */ new Set(["rowDataUpdated", "cellValueChanged", "rowValueChanged"]), C = Q(l, "modelValue"), F = g(!1), w = g(!1), E = e;
    M(
      C,
      (r, s) => {
        d.value && (w.value || (F.value = !0, b("rowData", R(r), R(s))), w.value = !1);
      },
      { deep: !0 }
    );
    const G = me(() => {
    ...
    }, V = () => C.value || o.rowData || o.gridOptions.rowData, L = () => {
      const r = [];
