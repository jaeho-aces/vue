...
TABLES: Dict[str, TableSchema] = {
    ...
    "MGMT_CCTV": TableSchema(
        ...
        fields=[
            ...
            TableField("ENC_URL", "varchar(100)", "인코더 URL"),
            ...
            TableField("VLINK_ID_S", "varchar(11)", "가상 노드 링크 시작점"),
            TableField("VLINK_ID_E", "varchar(11)", "가상 노드 링크 종료점"),
            TableField("ROAD_ID", "varchar(5)", "설치 고속도로 ID"),
            TableField("ROAD_NAME", "varchar(100)", "설치 고속도로 이름"),
            ...
            TableField("FILEURL_IMG", "varchar(100)", "정지 영상 저장 경로"),
            TableField("STAT", "char(1)", "처리 중 표식"),
            TableField("ALIVE", "char(1)", "동작 중인지 표시"),
            TableField("ALIVE_YN", "char(1)", "ALIVE 사용 여부"),
            TableField("UPDATE_DATE", "timestamp", "수정 일자"),
            TableField("LAST_CCTV_TIME", "timestamp", "마지막으로 CCTV 동작한 시간"),
            TableField("HLS_URL", "varchar(100)", "HLS URL"),
            TableField("HLS_ALIVE", "char(1)", "HLS 동작 여부"),
            TableField("HLS_DURATION", "numeric(3)", "HLS 개별 파일별 지속 시간"),
            TableField("HLS_EMERGENCY", "char(1)", "응급 URL 여부"),
            TableField("FTP_SENT_DATE", "timestamp", "FTP 전송 시간"),
    ...
    "MGMT_TRANS": TableSchema(
        ...
        fields=[
            ...
            TableField("TRANS_PORT", "numeric(5,0)", "변환 서버 포트"),
            TableField("ALIVE", "char(1)", "동작 여부"),
            TableField("ALIVE_TIME", "timestamp", "마지막 동작 확인 시간"),
            TableField("JSON_JOB", "varchar(10)", "JSON 작업"),
            TableField("JSON_YN", "char(1)", "JSON 처리 여부"),
            TableField("JSON_DATE", "timestamp", "처리 일자"),
    ...
    "MGMT_VERSION": TableSchema(
        ...
        key=["KEY", "PRODUCT"],
        comment="제품 버전 및 배포 파일 경로 관리",
        fields=[
            TableField("KEY", "varchar(64)", "항목 식별 키"),
            TableField("PRODUCT", "varchar(64)", "제품명"),
